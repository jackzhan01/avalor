...
私有认知与公开表达的两阶段分离与系统所有的防泄露闸、
**提示能力表（替掉版本等值判断）、坏人出牌协调、自然中文公开发言、投票纪律与刺杀候选排序**。
...
> M5 / M5.1 / M5.2 / M5.3 的设计说明在
> [`cognition/README.md`](./cognition/README.md)、[`README-M5.1.md`](./cognition/README-M5.1.md)、
> [`README-M5.2.md`](./cognition/README-M5.2.md)、[`README-M5.3.md`](./cognition/README-M5.3.md)、
> [`README-M5.4.md`](./cognition/README-M5.4.md)，
> 还没有并进这份 README。
...
```bash
npm run test:sim      # 1,288 项 / 66 个文件，全部离线，约 15 秒
```
